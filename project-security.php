...
// HERE WILL BE KORFISH DATABASE CONNECTION

$servername = "localhost";
$username = "korfishw_nkhacker";
$password = "Nikhilesh@123";
$dbname = "korfishw_security_test";
$prefix   = "";

// $servername = "92.204.175.218";
// $username = "learnhac_korfish";
// $password = "~7[Bpw_3^{Xk";
// $dbname = "learnhac_test";
// $prefix = "";

$mysqli = new mysqli($servername,$username,$password,$dbname);
$ip = $_SERVER['REMOTE_ADDR'];
if($mysqli)
echo "Cconnection Succes";
{
...
$urlParts = parse_url($input);
    ...
    // Remove www.
    $domain_name = preg_replace('/^www\./', '', $input);
    
	$websitename = $website.$domain_name;
            include_once "lib/ip_details.php";
            $log = $mysqli->query("INSERT INTO `logs` (`ip`, `date`, `time`,`website_name`, `page`, `query`, `type`, `browser`, `browser_code`, `os`, `os_code`, `country`, `country_code`, `region`, `city`, `latitude`, `longitude`, `isp`, `useragent`, `referer_url`) VALUES ('$ip', '$date', '$time','$websitename', '$page', '$querya', '$type', '$browser', '$browser_code', '$os', '$os_code', '$country', '$country_code', '$region', '$city', '$latitude', '$longitude', '$isp', '$useragent', '$referer')");
            
            //  SENDING MAIL TO CLIENT
            if($log)
            {
                $to      = 'Nikhilesh.Khot@onesmarter.com';
                $subject = 'KORFISH SECURITY - ' . $type . '';
                $message = '<p>IP Address: <strong>' . $ip . '</strong></p>
                ...
                $headers = 'From: khotnikhilesh1999@gmail.com' . "\r\n" .
                    'Reply-To: nikhileshkhot1999@gmail.com' . "\r\n" .
...
<?php
 ...
 //SQLi Protection
$query = $mysqli->query("SELECT * FROM `sqli-settings`");
